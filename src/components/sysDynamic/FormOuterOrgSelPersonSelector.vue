...
import outerOrgSelPersonDialog from '@/components/sysSettingDialog/outerOrgSelPerson.dialog'

export default {
  name: 'FormOuterOrgSelPersonSelector',
  mixins: [FormMixin],
  components: { outerOrgSelPersonDialog },
  props: {
    zoom: {
      type: Number,
      default: function () {
